  ...
  return (
    <main className="min-h-screen flex flex-col bg-bg" data-testid="login-page">
      ...
      <div className="border-b border-border">
        <div className="max-w-[1280px] mx-auto px-6 max-sm:px-3 h-[80px] max-sm:h-[60px] flex items-center">
      ...
      <div className="flex-1 flex items-center justify-center p-6 max-sm:p-3">
        <section className="w-full max-w-[568px] max-sm:max-w-[calc(100%-24px)] bg-bg rounded-xl shadow-lg border border-border overflow-hidden" aria-labelledby="login-title">
          {/* Modal header */}
          <div className="flex items-center justify-center py-5 px-6 max-sm:px-4 border-b border-border">
          ...
          <div className="p-6 max-sm:p-4">
            <h1 id="login-title" className="text-[22px] max-sm:text-[20px] font-semibold text-text mb-2" data-testid="login-title">
