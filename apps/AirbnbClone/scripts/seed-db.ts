...
export async function seedDatabase(databaseUrl: string): Promise<void> {
  ...
  await sql`
    ...
    ('e7777777-7777-7777-7777-777777777777', 'b2222222-2222-2222-2222-222222222222', 'a3333333-3333-3333-3333-333333333333', '2026-07-01', '2026-07-05', 2, 1900, 'confirmed', NULL)
  `
